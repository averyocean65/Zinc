...
void Shader::Draw(unsigned int nrOfIndices, unsigned int* indices)
{
...
void Shader::SetVec2(const char* name, glm::fvec2 value)
{
	Use();
...
void Shader::SetVec4(const char* name, glm::fvec4 value)
{
	Use();
...
void Shader::SetMat3(const char* name, glm::mat3 value, bool transpose)
{
	Use();
...
void Shader::SetMat4(const char* name, glm::mat4 value, bool transpose)
{
	Use();
...
void Shader::SetView(const char* name, glm::mat3 value, bool transpose)
{
	Use();
